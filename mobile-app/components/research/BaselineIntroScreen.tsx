...
// Introduction / instructions shown once the focus domain is confirmed and
// the baseline assessment is about to begin.
export const BaselineIntroScreen: React.FC<Props> = ({
  onContinue,
  loading = false,
  error = null,
  testID,
}) => {
  const copy = researchCopy.baselineIntro;
